...
mobileAccount.addEventListener('click', () => {
    mobileBag.classList.remove('show')
...
mobileAccount.addEventListener('touchend', (e) => {
    e.stopPropagation();
})
...
let bag = doc.getElementById('bag')
...
//// Seperate listner for tablet < devices (in particular ipads/iphone)
let mobileBag = doc.getElementById('mobile-bag')

mobileBag.addEventListener('click', () => {
    mobileAccount.classList.remove('show')
    mobileBag.classList.add('show')
})
...
mobileBag.addEventListener('touchend', (e) => {
    e.stopPropagation();
})
